...
$verifypassword = $_SESSION['verifypwd'];
$phonenumber = $_SESSION['phonenumber'];
$Address1 = $_SESSION['Address1'];
$Address2 = $_SESSION['Address2'];
$city = $_SESSION['city'];
$state = $_SESSION['state'];
$genderradio = $_SESSION['genderradio'];
$marriedradio = $_SESSION['marriedradio'];
		...
		<div class="row">
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<div class="col-xs-12 col-sm-6 col-md-6 col-md-offset-3 col-lg-2 col-lg-offset-2 ">
					...
					<br />
					<input type="text" class="form-control" name="date" id="datepicker" placeholder="Date of Birth" value="<?php echo $birthDate ; ?>" disabled />
