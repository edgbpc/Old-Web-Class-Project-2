		...
		<div class="row">
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
				<div class="col-xs-12 col-sm-6 col-md-6 col-md-offset-3 col-lg-2 col-lg-offset-2 ">
					<input type="text" class="form-control" title="Must be between 6 and 50 characters. Required" name="username" id="username" maxlength="50" placeholder="Username" value="<?php echo $username; ?>" onblur="changeToBlack(this)" required  />
                    <span class="error"><?php echo $usernameErr;?></span><br />
					<input type="email" class="form-control" title="Required." name="email" id="email" maxlength="255" placeholder="Email Address" value="<?php echo $email; ?>"  onblur="changeToBlack(this)" required  />
					...
					<input type="text" class="form-control" title="Required." name="zipcode" id="zipCode" maxlength="10" placeholder="Zip Code" value="<?php echo $zipCode; ?>" onkeyup="formatZipCode(this)" onblur="validateZipLength(this)" required />
				...
				<div class="col-md-6 col-md-offset-3 col-lg-2 col-lg-offset-0 ">
					<input type="password" title="Must contain 1 Upper, 1 Lower, 1 Digit and 1 Special Character and be at least 8 characters" class="form-control" name="pwd" id="pwd" maxlength="50" placeholder="Password"  onblur="changeToBlack(this)" required />
					<span class="error"><?php echo $passwordErr;?></span><br />
					<input type="password" class="form-control" title="Reenter password to confirm." name="verifypwd" id="verifypwd" maxlength="50" placeholder="Verify Password" onblur="changeToBlack(this)" required />
					<span class="error"><?php echo $verifyPasswordErr;?></span><br />
					<!-- max length should be 13, not 12, to accomodate characters "(", ")", and "-" -->
					<input type="text" class="form-control" title="Required." name="phonenumber" id="phonenumber" maxlength="13" placeholder="(XXX)XXX-XXXX" value="<?php echo $phonenumber; ?>"  onkeyup="formatPhone(this)" required/>
